  ...
  switch(parsedURL.pathname) {
    case '/fileupload':
      ...
      form.parse(req, function (err, fields, files) {
        ...
        var GPSX = (fields.GPSX.length > 0) ? fields.GPSX : null;
        var GPSY = (fields.GPSY.length > 0) ? fields.GPSY : null;
    ...
    case '/new':
      ...
      res.write('GPSX:<input type="GPSX" name="GPSX"><br>');
      res.write('GPSY:<input type="GPSY" name="GPSY"><br>');
