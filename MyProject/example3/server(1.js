  ...
  if (parsedURL.pathname == '/fileupload') {
    ...
    MongoClient.connect(mongourl, function(err,db) {
      ...
      findPhoto(db,criteria,function(photo) {
        ...
        console.log('Photo type='+photo[0].minetype)
        console.log('Photo base64='+photo[0].image)
        res.writeHead(200, {'Content-Type': 'text/html'});
        res.write('<img src="data:'+photo[0].mimetype+';base64, '+photo[0].image+'" width = "500" height ="100" alt="base64 test">');
